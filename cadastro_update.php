...
<form  class="form" method="POST" id="signup-form" class="signup-form" action="update.php?id=<?php echo $_GET['id']; ?>">
  <br>
  ...
  <button type="submit" name="submit" id="submit" value="Cadastrar" class="btn btn-primary"> Atualizar</button>
  <br> <br>
</form>
